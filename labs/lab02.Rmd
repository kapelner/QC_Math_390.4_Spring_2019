...
* Sort the rows matrix `R` by the largest row sum to lowest.
...
* Fit a perceptron model explaining `y` using all three features. Try to write your own code to do this even though I will do this in class. Provide the estimated parameters (i.e. the four entries of the weight vector). 
